...
<form method="POST" action={action} enctype="multipart/form-data">
  ...
  <div class="mt-3 flex min-h-11 items-center gap-3 rounded-lg border border-[#eae4f2] px-3 py-2.5">
    ...
    <button type="submit" class="btn btn-primary ml-auto shrink-0">{buttonLabel}</button>
  </div>
</form>
