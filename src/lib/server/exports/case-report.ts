...
export function buildCaseReportRows(detail: CaseDetailView, generatedAt: string): ReportRow[] {
  const rows: ReportRow[] = [
    ...
    ['Case summary', 'Source alert harm priority', detail.caseRecord.severity, ''],
    ...
    ['Source alert', 'Reference', detail.alert.sourceReference, detail.alert.source],
    ['Source alert', 'URL', detail.alert.sourceUrl, ''],
    ['Source alert', 'Title', detail.alert.title, ''],
    ['Source alert', 'Product', detail.alert.productName, detail.alert.risk],
